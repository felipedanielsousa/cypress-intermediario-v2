Cypress.Commands.add('login', (
    ...
    //variável login, que executa a função de logar e armazena cache na variavél
    const login = () => {
    ...
    //se o location não for igual /users/sign_in, então a sessão será restaurada (passando o validade no obj options)
    const validate = () => {
      cy.visit('/')
